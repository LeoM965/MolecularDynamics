...
namespace Constants {
    ...
    const double BOND_FORCE_CONST = 350.0 * KCAL_PER_MOL_TO_JOULES / (AVOGADRO * ANGSTROM_TO_METERS * ANGSTROM_TO_METERS);
    const double ANGLE_FORCE_CONST = 40.0 * KCAL_PER_MOL_TO_JOULES / AVOGADRO;
    ...
    const char* const ATOM_SYMBOLS[6] = { "C", "H", "O", "N", "Be", "Cl" };
}
